    ...
    <article className="overflow-hidden">
      <section className="relative min-h-[auto] border-b border-[var(--color-line)] lg:min-h-[72vh]">
        ...
        <div className="relative mx-auto grid max-w-6xl grid-cols-1 gap-6 px-4 py-8 text-[var(--color-cream)] sm:px-6 lg:min-h-[72vh] lg:grid-cols-[1.08fr_0.92fr] lg:items-end lg:py-10">
          <div className="pb-2">
            ...
            <h1 className="display mt-3 max-w-3xl text-5xl text-[var(--color-cream)] sm:text-6xl lg:text-7xl">
            ...
            <div className="rrn-tap-row mt-6">
              ...
              <Link
                ...
                className="rrn-tap btn-blue inline-flex rounded-lg px-5 py-3 text-sm font-bold"
              >
                Try story flow
              </Link>
            </div>
          ...
          <div
            id="story-path"
            className="rounded-lg border border-[var(--color-line)] bg-[var(--color-surface-2)] p-4 text-[var(--color-ink)] shadow-[0_20px_50px_rgba(0,0,0,0.5)] sm:p-5"
            data-reveal
          >
            ...
            <div className="mt-4 grid gap-2">
              {[
                ...
                >
                  <span className="mt-1 flex h-3 w-3 items-center justify-center rounded-full bg-[var(--color-gold)]" aria-hidden />
                  <span>
            ...
            <div className="rrn-tap-row mt-4">
              <a
                href="#service-match"
                className="rrn-tap btn-ghost inline-flex rounded-lg px-4 py-2 text-sm font-black"
              >
                See what I build
              </a>
              <Link
      ...
      <section className="mx-auto max-w-6xl px-4 py-5 sm:px-6 sm:py-6">
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-4">
          {[
            ...
            <div
              key={title}
              className="rounded-lg border border-[var(--color-line)] bg-[var(--color-surface)] p-4 shadow-[0_20px_50px_rgba(0,0,0,0.35)]"
              data-reveal
      ...
      <section id="service-match" className="mx-auto max-w-6xl px-4 pb-8 sm:px-6">
        <div className="grid gap-4 rounded-lg border border-[var(--color-line)] bg-[var(--color-surface)] p-4 sm:p-5 lg:grid-cols-[0.75fr_1.25fr]">
          <div>
            <p className="eyebrow">Pick the smallest smart move</p>
          ...
          <div className="grid gap-3 md:grid-cols-[1fr_1fr_1.1fr]">
            <label className="block">
              ...
              <select
                ...
                className="mt-1 w-full rounded-lg border border-[var(--color-line)] bg-[var(--color-surface-2)] px-3 py-3 text-sm"
              >
                {PROBLEMS.map((item) => (
            ...
            <div className="rounded-lg border border-[var(--color-gold)] bg-[var(--color-surface-2)] p-3">
              <div className="flex items-start justify-between gap-2">
                ...
                <p className="display text-xl tabular-nums text-[var(--color-gold)]">
                  {pick.price}
                </p>
              </div>
              <TrackerLink
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            {SERVICES.map((service) => (
              <button
                ...
                className={[
                  "min-h-36 rounded-lg border bg-[var(--color-surface-2)] p-4 text-left transition",
                  focused.slug === service.slug
                    ? "border-[var(--color-gold)] shadow-[0_20px_50px_rgba(0,0,0,0.45)]"
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <p className="display text-lg tabular-nums text-[var(--color-gold)]">
                    {service.price}
                  </p>
                </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:py-10">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_0.9fr]">
          <div className="rounded-lg border border-[var(--color-line)] bg-[var(--color-surface)] p-5 shadow-[0_20px_50px_rgba(0,0,0,0.35)] sm:p-6">
            ...
            <div className="mt-5 grid grid-cols-1 gap-3 md:grid-cols-3">
              {focused.details.map((detail) => (
                <div
                  key={detail}
                  className="rounded-lg border border-[var(--color-line-soft)] bg-[var(--color-surface-2)] p-4"
                >
            ...
            <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <p className="rounded-full border border-[var(--color-line)] bg-[var(--color-surface-2)] px-4 py-2 text-xs font-black uppercase tracking-normal text-[var(--color-blue-ink)]">
                {focused.proof}
              </p>
              <TrackerLink
                service={focused}
          ...
          <div className="rounded-lg border border-[var(--color-blue)] bg-[var(--color-blue-soft)] p-5 text-[var(--color-ink)] shadow-[0_20px_50px_rgba(0,0,0,0.35)] sm:p-6">
            <p className="eyebrow">Attention mechanisms</p>
            <h2 className="mt-2 text-3xl font-black tracking-normal text-[var(--color-cream)]">
              Keep visitors moving.
            </h2>
            <ul className="mt-5 space-y-3 text-sm leading-relaxed text-[var(--color-ink-soft)]">
      ...
      <section className="border-y border-[var(--color-line)] bg-[var(--color-navy)] text-[var(--color-cream)]">
