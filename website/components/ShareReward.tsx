  ...
  return (
    ...
    >
      <div className="relative flex flex-col items-center">
        <span className="animate-share-pop whitespace-nowrap rounded-full border border-[var(--color-accent)] bg-[var(--color-surface-2)] px-3 py-1 text-[11px] font-bold text-[var(--color-accent-ink)] shadow-lg">
          {label} 🇺🇸
        </span>
