...
export function MobileSupportBar() {
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-10 border-t border-[var(--color-line)] bg-[var(--color-paper)]/95 backdrop-blur-xl px-4 py-2.5 flex items-center justify-between gap-3">
