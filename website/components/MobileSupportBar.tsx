    ...
    >
      ...
      >
        ...
        <Link
          ...
          className="inline-flex min-h-11 items-center justify-center rounded-lg border border-[var(--color-gold-bright)] bg-[var(--color-gold-bright)]/15 px-1 text-center text-xs font-black text-[var(--color-gold-bright)]"
        >
          Join
        </Link>
      </nav>
