    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          ...
          <p className="mt-1 font-display text-2xl font-bold leading-tight tracking-tight text-[var(--color-cream)] sm:text-3xl">
            {person.name}
          </p>
          <p className="mt-1 text-xs font-semibold leading-snug text-[var(--color-cream)]/70 sm:text-sm">
            {roleLine}
          </p>
        </div>
        {person.photo_url ? (
      ...
      <p className="mt-6 max-w-xl font-display text-xl font-bold leading-snug text-[var(--color-cream)] sm:text-2xl">
