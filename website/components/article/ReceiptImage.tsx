    ...
    <>
      ...
      {open ? (
        <div
          ...
          className="fixed inset-0 z-50 grid cursor-zoom-out place-items-center bg-black/90 p-4"
        ...
        >
          ...
          <button
            type="button"
            onClick={() => setOpen(false)}
            className="absolute right-4 top-4 grid h-10 w-10 place-items-center rounded-full border border-[var(--color-line)] bg-[var(--color-surface)] text-xl font-bold text-[var(--color-cream)]"
            aria-label="Close"
          >
            ×
          </button>
