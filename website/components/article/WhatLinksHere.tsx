        ...
        {sources.map((r) => (
          <li key={r.from_post_id}>
            <Link
              ...
              className="group flex items-center justify-between gap-3 rounded-md border border-[var(--color-line)] bg-[var(--color-paper)] px-3.5 py-2.5 transition hover:border-[var(--color-gold)]"
            >
