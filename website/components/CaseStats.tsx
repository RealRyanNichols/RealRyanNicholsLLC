  ...
  return (
    <div className={cls}>
      <Stat
        ...
        value={views}
        label={size === "md" ? "views" : null}
        ariaLabel={`${views} views`}
      />
      {typeof comments === "number" ? (
        <Stat
          icon={<CommentIcon className={iconCls} />}
          value={comments}
          label={size === "md" ? (comments === 1 ? "comment" : "comments") : null}
          ariaLabel={`${comments} comments`}
        />
      ) : null}
      <Stat
        icon={<ShareIcon className={iconCls} />}
        value={shares}
        label={size === "md" ? (shares === 1 ? "share" : "shares") : null}
        ariaLabel={`${shares} shares`}
      />
    </div>
  );
}
