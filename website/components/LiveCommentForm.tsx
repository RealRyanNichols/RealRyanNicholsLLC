    ...
    >
      ...
      <div className="mt-3 grid gap-2">
        <input
          ...
          autoComplete="name"
          className="w-full rounded-lg border border-[var(--color-line)] bg-[var(--color-surface)] px-3 py-2 text-sm focus:outline-none focus:border-[var(--color-accent)]"
        />
        <textarea
          required
          value={body}
      ...
      <div className="mt-3 flex items-center justify-between gap-3">
        ...
        <button
          ...
          className="rounded-full bg-[var(--color-accent)] px-4 py-2 text-xs font-black text-[var(--color-cream)] disabled:opacity-60"
        >
