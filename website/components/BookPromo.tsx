...
export function BookPromo({ className = "" }: { className?: string }) {
  return (
    <Link
      href="/book"
      className={`group block rounded-2xl border border-[#203a64] bg-[#071126] p-4 text-[#fdf8ea] transition hover:border-[#7fe3a9]/60 ${className}`}
    >
      <div className="flex items-center gap-4">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-1.5 text-xs font-semibold leading-snug text-[#cfd9ea]">
            ...
            <span className="font-black text-[#7fe3a9]">free</span>.{" "}
            <span className="whitespace-nowrap text-[#7fe3a9] group-hover:underline">
              Get on the list →
            </span>
          </p>
        </div>
