...
function ReserveButton() {
  ...
  return (
    <div>
      ...
      {error ? <p className="mt-2 text-center text-sm text-[var(--color-danger)]">{error}</p> : null}
  ...
  return (
    <div className="bg-[var(--color-paper)] text-[var(--color-cream)]">
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-center text-base text-[var(--color-ink-soft)] sm:text-lg">
          The site you&apos;re on right now? I built it — on a fast, modern,
          fully-owned stack. Yours can do{" "}
          <strong className="text-[var(--color-cream)]">anything you want</strong>, and it&apos;s
        ...
        {/* Who it's for */}
        <h2 className="mt-16 text-center text-2xl font-black text-[var(--color-cream)] sm:text-3xl">
          Who it&apos;s for
        </h2>
        ...
        <p className="mx-auto mt-3 max-w-2xl text-center text-[var(--color-ink-soft)]">
        ...
        <ul className="mx-auto mt-5 max-w-2xl space-y-3 text-[var(--color-ink-soft)]">
          <li>
            🏷️ <strong>Agencies charge thousands for a custom build.</strong>{" "}
            You&apos;re getting one at the founder rate of{" "}
            <strong className="text-[var(--color-gold)]">$250</strong>.
          </li>
          <li>
        ...
        <div className="mt-16 rounded-2xl border border-[var(--color-line-soft)] bg-[var(--color-cream)]/[0.03] p-6">
          ...
          <ul className="mt-3 space-y-2 text-sm text-[var(--color-ink-soft)]">
            <li>
              <strong className="text-[var(--color-cream)]">Price:</strong> $250 founder rate, one flat fee for the base build described above.
            </li>
            <li>
              <strong className="text-[var(--color-cream)]">Refunds:</strong> full refund any time before I start building. Once work has begun, the deposit covers time already spent — ask me and I&apos;ll be fair about it.
            </li>
            <li>
              <strong className="text-[var(--color-cream)]">Cancellation:</strong> you can cancel anytime; you keep whatever is built to that point.
            </li>
            <li>
              <strong className="text-[var(--color-cream)]">Ownership:</strong> after the 30-day build-out the site and its content are yours.
            </li>
            <li>
              This is a service agreement, not legal, tax, or financial advice.
            </li>
          </ul>
          <p className="mt-3 text-[11px] uppercase tracking-wider text-[var(--color-muted)]">
        ...
        <p className="mx-auto mt-12 max-w-xl text-center text-xs text-[var(--color-muted)]">
