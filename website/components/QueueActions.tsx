      ...
      {status === "draft" ? (
        <>
          <button
            ...
            disabled={!!busy}
            onClick={() => act("approve")}
            className="min-h-10 rounded-lg border border-[var(--color-line)] px-3.5 py-1.5 text-sm font-bold text-[var(--color-ink)] transition hover:bg-[var(--color-gold)] hover:text-[var(--color-navy)] disabled:opacity-50"
          >
