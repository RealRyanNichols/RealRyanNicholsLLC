...
export const DAYS: EmailDay[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "numbers", items: [
        ...
        { n: "02", t: "One evidence thumb drive", d: "What they told me was 14,000+ hours. Everything I could prove came off of it. Hold that number, because it moves." },
  ...
  {
    day: 24,
    subject: "They told me 14,000 hours. It was not 14,000 hours.",
    preview: "What I actually had, versus what existed. The gap is the story.",
    kicker: "The charts",
    title: "The number they gave me was wrong.",
    blocks: [
      { type: "p", text: "When I wrote this report I believed I was working from 14,000 hours of footage. That is 583 days of continuous video on its own. A year and seven months of never looking away." },
      { type: "p", text: "I did not have all of it. Not close." },
      { type: "p", text: "The 14,000 hours covered noon to eight PM on one day, and only what the Capitol Police handed the FBI. Half of that was withheld as not relevant. What actually reached defendants was 4,800 hours from 515 cameras." },
      { type: "chart", src: "footage-count", alt: "What they said existed, and what exists", caption: "Every figure here comes from a government filing, my own motion, or the House release." },
      { type: "p", text: "In February 2023 my own motion put 41,000 hours on the record. In November 2023 the House began releasing what it put at 44,000." },
      { type: "chart", src: "footage-scale", alt: "What 44,000 hours actually looks like", caption: "Every square is one full day of video. The red block is what reached defendants." },
      { type: "band", text: "I built this whole report out of about a tenth of what existed." },
      { type: "p", text: "And 44,000 is only what has been tracked and recovered. Nobody has told us it is the ceiling." },
