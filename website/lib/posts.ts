...
export const POST_COLUMNS =
  "id, slug, type, title, body, image_urls, media, mux_asset_id, mux_upload_id, mux_playback_id, mux_status, duration_seconds, thumbnail_url, pinned, status, author_id, category, published_at, created_at, updated_at, views_count, shares_count, inbound_shares_count";
