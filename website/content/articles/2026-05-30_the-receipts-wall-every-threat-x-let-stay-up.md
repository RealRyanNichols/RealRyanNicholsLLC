---
title: "The Receipts Wall: Every Threat X Let Stay Up"
subtitle: "Every death-penalty reply, slur, and mass-report admission X let sit while my account got locked."
author: "Ryan Nichols"
date: "2026-05-30"
category: "J6 Case"
slug: "the-receipts-wall-every-threat-x-let-stay-up"
status: "published"
pinned: false
---
...
![Receipts wall — Death threats, slurs, doxxing. What X let stay up while my account got locked. Four quote cards: @theliamnissan (verified, 460,200 followers) "You broke the law. Deal with it, fuckbag." STILL UP. @DrMLynne "You took part in January 6, you deserve life in prison." STILL UP. @LoriNash59 "Rot in Hell you unAmerican scum." STILL UP. @theliamnissan (verbatim admission, on the platform) "I'm just casually getting your account banned." STILL UP.](https://rpchhzncxigczfojfdtc.supabase.co/storage/v1/object/public/post-media/receipts/hero.jpg)
...
1. **The unprovoked attack.** A verified or pile-on account opens at me out of nowhere — usually under a grief post or a J6 post — with an obvious flame or slur.
2. **The bait reply.** A second account replies with a setup question designed to elicit a one-word answer ("Is that a threat?" / "Are you threatening him?" / "So you're a violent extremist now?"). That's called **fishing for a reportable line**.
3. **The mass-report.** I answer — usually sarcastically — and within minutes a coordinated cluster of accounts mass-reports the answer. X's automation locks me. Total time from post to lock: well under one human-review cycle.
4. **The victory lap.** The brigade then posts publicly, in the same thread, the actual hateful things — *Rot in Hell, deserve life in prison, slurs* — and **X doesn't touch any of it.**

You don't have to take my word for the structure. Here's the bait sitting in the thread itself.

![Thread overview from X showing the sequence: Ryan Nichols's May 21 video reading 'took my kids' under the caption 'This is what a Weaponized Biden DOJ looks like' (1.4K replies, 306 reposts, 566 likes, 312K views). Below it, the X 'This Post is from an account you blocked' notice for the harasser @garykoepnick. Then Ryan's reply: 'You are the worst America has to offer. Steal another election and see what happens.' Then a second 'This Post is from an account you blocked' notice for @LoriNash59 — whose 'Is that a threat?' bait reply Ryan can't see. Then the start of Ryan's sarcastic locked reply: 'Yes. Steal another election, and see what doesn't happen to you?'](https://rpchhzncxigczfojfdtc.supabase.co/storage/v1/object/public/post-media/receipts/thread-bait-trap.jpg)
...
![X tweet from Liam Nissan™ (verified, @theliamnissan) at 5:02 PM 5/22/26 reading: 'You broke the law. Deal with it, fuckbag' — followed by Ryan Nichols Sr.'s parody response 51 seconds later: 'I don't think you know who you're fucking with..'](https://rpchhzncxigczfojfdtc.supabase.co/storage/v1/object/public/post-media/receipts/liam-fuckbag.jpg)

**Tear-down:**

- `"Deal with it, fuckbag"` is, by every reasonable reading of X's own Abusive Behavior policy, **abusive content directed at a specific person**. Specific named target. Specific slur. Specific intent to demean.
- It was reported to X by his own followers exactly zero times in the way mine was, because his side of the network does not mass-report itself. The tweet is still public 24+ hours later. **Still up.**
...
![Liam Nissan™'s X profile page. Avatar in sunglasses with a cigarette. Bio: 'What I have is a particular set of skills; skills that make me a nightmare for Nazi dickbags on the internet. I joke and drive a Nissan (parody).' Location: 'Parody, TX'. 460,200 followers. Verified checkmark.](https://rpchhzncxigczfojfdtc.supabase.co/storage/v1/object/public/post-media/receipts/liam-profile.jpg)
...
![X tweet from Liam Nissan™ (verified, @theliamnissan): 'Hahahah is this jackass January 6th insurrectionist threatening me? A Japanese automobile? 🤣 #smokefleet show him some love' — quote-tweeting Ryan's parody reply.](https://rpchhzncxigczfojfdtc.supabase.co/storage/v1/object/public/post-media/receipts/liam-smokefleet.jpg)

**Tear-down:**

- `"is this jackass January 6th insurrectionist"` — that is a label I dispute, and I am not going to let it sit like neutral context. I am a **pardoned** citizen. My charges were dismissed with prejudice. That matters when the label is being used to justify a pile-on.
- `"#smokefleet show him some love"` is, by plain reading, **an instruction to a 460K-follower mob to pile onto a named user.** That is the textbook definition of *coordinated harassment* and *brigading* — which X's Abusive Behavior policy specifically prohibits.
- He doesn't bother to hide it. The hashtag is the whole point. **Still up. Still verified. Zero enforcement.**
...
![X tweet from Liam Nissan™ (verified, @theliamnissan) at 5:24 PM May 22, 2026, 476 Views: 'Who said I'm scared. I'm just casually getting your account banned for "trying to find me" as you say. It's a threat'](https://rpchhzncxigczfojfdtc.supabase.co/storage/v1/object/public/post-media/receipts/liam-banned-admission.png)

**Tear-down:**

- `"I'm just casually getting your account banned"` is **a verbatim, on-platform admission of coordinated mass-reporting**. There is no rhetorical reading of this that isn't an admission of intent to weaponize the report function.
- He frames a *Taken* movie quote — which his own bio is built on — as "a threat" so the report queue catches it. Pure trap. Pure brigading.
...
![X account restriction notice: 'We've temporarily limited some of your account features. Account will be restored to full functionality in: 6 days and 23 hours. Ryan Nichols Sr. @RealRyanNichols.'](https://rpchhzncxigczfojfdtc.supabase.co/storage/v1/object/public/post-media/receipts/x-ban-6-days.png)
...
![X reply from MT (@DrMLynne) to @theliamnissan and @RealRyanNichols, 2 hours ago: 'You took part in January 6, you deserve life in prison.'](https://rpchhzncxigczfojfdtc.supabase.co/storage/v1/object/public/post-media/receipts/drmlynne-life-in-prison.jpg)
...
> *Still up. No lock. No "Violent Speech" warning. No flag. No automated review.*
...
![Ryan Nichols's reply (verified, @RealRyanNichols, 3:57 PM May 22, 2026, 166 Views): 'Yes. Steal another election, and see what doesn't happen to you? Did you not just watch what happened to Maduro? Did you not just see the discombobulater? Delta force, and space force will take care of you. I don't have to do anything. I'm gonna be too busy on my yacht with your tax money paying for it to worry about you.'](https://rpchhzncxigczfojfdtc.supabase.co/storage/v1/object/public/post-media/receipts/locked-tweet.jpg)
...
Source: [X status 2060821139182547294](https://x.com/420FuckNazis69/status/2060821139182547294)
...
Source: [X status 2026357399213240783](https://x.com/SMacKenzie47/status/2026357399213240783)
...
Source: [X status 1987598629771551139](https://x.com/TylerThe30518/status/1987598629771551139)
...
Source: [X status 1956091006866350548](https://x.com/makeupdoug/status/1956091006866350548)
...
Source: [X status 2058374330145542264](https://x.com/walthodgson/status/2058374330145542264)
...
Source: [X status 2058016094648975382](https://x.com/BennieFergusen/status/2058016094648975382)
...
Source: [X status 2057893831551365366](https://x.com/HighTide_OTSS/status/2057893831551365366)
...
**3. [Donate →](/support).** I am spending my last dime on this site, the J6 case archive, mental-health care after pretrial detention, and the open-platform build that ends this cycle for everyone. **Public pledge:** if a major settlement / payout arrives, the donate link comes down the same day. No bait. No bullshit.
...
- 🔥 The first X-ban-for-parody, May 22 → [Banned from X for a parody](/posts/banned-from-x-for-a-parody-this-is-why-i-own-my-domain)
- 🚫 The second X-lock, this morning, for "Space Force" and "discombobulater" → [Banned again — Space Force / discombobulater](/posts/banned-again-for-space-force-and-discombobulater-meanwhile-rot-in-hell-stays-up)
- ⚖️ Judge Hogan on the record: "I accept your argument that his due process rights were violated." → [Judge Hogan transcript](/posts/judge-hogan-on-the-record)
- 🏛️ What it actually looks like inside the DC Jail → [Inside the DC Jail](/posts/inside-the-dc-jail)
- 🇺🇸 The J6 Anti-Weaponization Case Builder — 1,567 defendants, profiles, free, forever → [/j6](/j6)
- 📍 The Map Room — readers reading this *right now*, where they are reading from → [/the-map-room](/the-map-room)
...
**[ Share this post → ](https://twitter.com/intent/tweet?text=The%20Receipts%20Wall%3A%20every%20death%20threat%20and%20slur%20X%20let%20stay%20up%20against%20a%20pardoned%20J6%20citizen.&url=https%3A%2F%2Fwww.realryannichols.com%2Fposts%2Fthe-receipts-wall-every-threat-x-let-stay-up) · [ Donate → ](/support) · [ Build with me → ](mailto:theflashflash24@gmail.com?subject=OPEN%20PLATFORM)**
