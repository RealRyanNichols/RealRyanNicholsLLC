...
rec("/fuel shows the ledger bill", /a month in tokens/.test(html), (html.match(/\$[\d,]+ a month in tokens/) || [""])[0]);
rec("/fuel lists the AI line items from the ledger", /Claude Code/.test(html) && /ChatGPT/.test(html));
