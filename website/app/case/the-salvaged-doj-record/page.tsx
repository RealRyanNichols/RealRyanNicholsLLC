...
export default async function SalvagedDojRecordPage({
  ...
  return (
    <article className="mx-auto max-w-5xl px-4 py-8 sm:py-10">
      ...
      {/* The "Start here" card that used to sit here linked to
          /evidence-the-doj-tried-to-erase, which next.config.mjs redirects
          back to this page — a loop. It is gone until the explainer has a
          reachable home. */}
