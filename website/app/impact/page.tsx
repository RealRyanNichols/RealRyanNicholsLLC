    ...
    <main className="mx-auto max-w-5xl px-4 py-10">
      ...
      <section className="mt-12">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-x-5 gap-y-1 text-sm">
          <Link href="/services" className="inline-flex min-h-11 items-center font-bold text-[var(--color-accent-ink)] hover:underline sm:min-h-0">
            Hire Ryan — sites, dashboards, investigations →
          </Link>
          <Link href="/store" className="inline-flex min-h-11 items-center font-bold text-[var(--color-accent-ink)] hover:underline sm:min-h-0">
            Browse the store →
          </Link>
        </div>
      </section>
