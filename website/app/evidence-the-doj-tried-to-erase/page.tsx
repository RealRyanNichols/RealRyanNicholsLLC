...
export default async function EvidenceErasedPage() {
  ...
  return (
    <article className="mx-auto max-w-5xl px-4 py-8 sm:py-12">
      ...
      <div className="rounded-3xl border-2 border-[var(--color-blue)] bg-gradient-to-br from-[var(--color-surface)] via-[var(--color-surface)] to-[var(--color-surface-2)] p-6 sm:p-10 relative overflow-hidden">
        <div
...
function DarkStat({ value, label }: { value: number; label: string }) {
  return (
    <div className="rounded-xl border border-[var(--color-line-soft)] bg-[var(--color-surface)]/60 p-4">
