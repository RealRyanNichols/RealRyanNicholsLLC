...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticEntries: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE.url}/thebiglie`, lastModified: now, changeFrequency: "weekly", priority: 0.95 },
    { url: `${SITE.url}/thebiglie/report/index.html`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
